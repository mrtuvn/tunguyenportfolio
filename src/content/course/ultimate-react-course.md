...
description: "Tu Nguyen | Ultimate 1:1 React Course"
author: "Tu Nguyen"
img: "/assets/react-course.webp"
img_alt: "Ultimate React Course"
...
<div class="flex items-center justify-center flex-col md:flex-row">
  ...
  <div class="ml-2">
    <a href="https://www.facebook.com/mrtu.vn" target="_blank" class="text-white bg-[#3b5998] hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 me-2">
    ...
    <a href="mailto:tuna9x.it@gmail.com" class="text-white bg-[#FF9119] hover:bg-[#FF9119]/80 focus:ring-4 focus:outline-none focus:ring-[#FF9119]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#FF9119]/80 dark:focus:ring-[#FF9119]/40 me-2">
